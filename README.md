...
## v3 update
Replace `index.html` and `sw.js` in the repository root to update an existing installation.
Touch the small top-center `⌄` handle to open the controls, then choose **Load File**.
